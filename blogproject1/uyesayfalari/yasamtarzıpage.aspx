<%@ Page Title="" Language="C#" MasterPageFile="~/uyesayfalari/ana.Master" AutoEventWireup="true" CodeBehind="yasamtarzıpage.aspx.cs" Inherits="blogproject1.uyesayfalari.yasamtarzıpage" %>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="bradcumb-title text-center">
                        <h2>Yaşam Tarzı Blogları Sayfası</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Yaşam Tazı Sayfası</li>
                        </ol>
                    </nav>
                </div>
            </div>
