<%@ Page Title="" Language="C#" MasterPageFile="~/uyesayfalari/ana.Master" AutoEventWireup="true" CodeBehind="fitnesspage.aspx.cs" Inherits="blogproject1.uyesayfalari.fitnesspage" %>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="bradcumb-title text-center">
                        <h2>Fitness Blogları Sayfası</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Fitness Sayfası</li>
                        </ol>
                    </nav>
                </div>
            </div>
