<%@ Page Title="" Language="C#" MasterPageFile="~/uyesayfalari/ana.Master" AutoEventWireup="true" CodeBehind="anasayfa.aspx.cs" Inherits="blogproject1.uyesayfalari.anasayfa" %>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="row">
                        ...
                        <!-- Single Post2 -->
                        <asp:Repeater ID="RepeaterSondanBirOnceki" runat="server">
                            <ItemTemplate>
                        ...
                        <!-- Single Post3 -->
                        <asp:Repeater ID="RepeaterSondanIkıOnceki" runat="server">
                            <ItemTemplate>
                                <div class="col-12 col-md-6">
                        ...
                        <!-- Single Post4 -->
                        <asp:Repeater ID="RepeaterSondanUc" runat="server">
                            <ItemTemplate>
                                <div class="col-12 col-md-6">
                                    <div class="single-post wow fadeInUp" data-wow-delay=".6s">
                                        <!-- Post Thumb -->
                        ...
                        <!-- Single Post -->
                        <asp:Repeater ID="RepeaterSondanDort" runat="server">
                            <ItemTemplate>
                                <div class="col-12 col-md-6">
                                    <div class="single-post wow fadeInUp" data-wow-delay=".6s">
                                        <!-- Post Thumb -->
                        ...
                        <!-- Single Post -->
                        <asp:Repeater ID="RepeaterSondanBes" runat="server">
                            <ItemTemplate>
                                <div class="col-12">
                        ...
                        <!-- Single Post -->
                        <asp:Repeater ID="RepeaterSondanAlti" runat="server">
                            <ItemTemplate>
                                <div class="col-12">
                        ...
                        <!-- Single Post -->
                        <asp:Repeater ID="RepeaterSondanYedi" runat="server">
                            <ItemTemplate>
                                <div class="col-12">
                        ...
                        <!-- Single Post -->
                        <asp:Repeater ID="RepeaterSondanSekiz" runat="server">
                            <ItemTemplate>
                                <div class="col-12">
                                    <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".8s">
                                        <!-- Post Thumb -->
