<%@ Page Title="" Language="C#" MasterPageFile="~/uyesayfalari/ana.Master" AutoEventWireup="true" CodeBehind="ebeveynlikpage.aspx.cs" Inherits="blogproject1.uyesayfalari.ebeveynlikpage" %>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="bradcumb-title text-center">
                        <h2>Ebeveyn Blogları Sayfası</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Ebeveyn Sayfası</li>
                        </ol>
                    </nav>
                </div>
            </div>
