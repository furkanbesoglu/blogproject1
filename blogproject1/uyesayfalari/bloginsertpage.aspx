<%@ Page Title="" Language="C#" MasterPageFile="~/uyesayfalari/ana.Master" AutoEventWireup="true" CodeBehind="bloginsertpage.aspx.cs" Inherits="blogproject1.uyesayfalari.bloginsertpage" %>
                ...
                <div class="form-horizontal">
                                ...
                                <div class="col-12">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active">Blog Ekleme Sayfası</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <asp:Image ID="imgPicture" Width="450px" Height="450px" ImageUrl="~/uyesayfalari/images/uploadFoto.jpg" runat="server" class="img-thumbnail" alt="Cinque Terre" />
                            <asp:FileUpload ID="fluPicture" onchange="this.form.submit();" runat="server" Width="235" />
                    ...
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="txtFroncontent" CssClass="col-md-2 control-label">Ön İçerik :</asp:Label>
                        <div class="col-md-10">
                            <%-- <asp:TextBox runat="server" ID="AGE1" CssClass="form-control"  />--%>

                            <dx:ASPxTextBox ID="txtFroncontent" runat="server" CssClass="form-control"></dx:ASPxTextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <textarea id="TextAreaDetail" cols="50" rows="6" class="form-control" runat="server"></textarea>
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Blog Ekle" CssClass="btnBlog" UseSubmitBehavior="False" OnClick="ASPxButton1_Click"></dx:ASPxButton>
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label runat="server" style="color:red; margin-left:-15px;"  ID="SONUC" CssClass="col-md-10 control-label"></asp:Label>
