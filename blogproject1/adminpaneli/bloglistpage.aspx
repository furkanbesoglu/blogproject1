<%@ Page Title="" Language="C#" MasterPageFile="~/adminpaneli/admin.Master" AutoEventWireup="true" CodeBehind="bloglistpage.aspx.cs" Inherits="blogproject1.adminpaneli.bloglistpage" %>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:HyperLink ID="HyperLink1" Width="100px" Height="35px" Font-Size="Large" NavigateUrl='<%# "~/adminpaneli/blogdelete.aspx?blogID="+Eval("blogID")%>' runat="server" CssClass="btn btn-primary">SİL</asp:HyperLink>
                        </td>
